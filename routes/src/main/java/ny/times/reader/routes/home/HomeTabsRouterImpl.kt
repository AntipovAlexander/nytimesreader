...
class HomeTabsRouterImpl @Inject constructor(navigationManager: NavigationManager) :
    HomeTabsRouter {
    override val tabsRoutes: Flow<HomeTabsRoutes> = navigationManager.commands.filterIsInstance()
}